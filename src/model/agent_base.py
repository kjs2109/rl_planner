...
from configs.configs import (GAMMA, BATCH_SIZE, LR, TAU, MAX_TRAIN_STEP, ORTHOGONAL_INIT, LR_DECAY)
...
class AgentBase(ABC):
    def __init__(
        self, config_type, configs:dict, verbose:bool=False, save_params:bool=False, load_params:bool=False) -> None:
